# SFEIR School DBT - Setup Étudiant Portable (PowerShell)
# Mode portable : Installation sans Docker

Write-Host "╔═══════════════════════════════════════════════════╗" -ForegroundColor Green
Write-Host "║  SFEIR School DBT - Setup Étudiant Portable      ║" -ForegroundColor Green
Write-Host "╚═══════════════════════════════════════════════════╝" -ForegroundColor Green
Write-Host ""
...
if (-Not (Test-Path $profilePath)) {
    ...
    if (-Not ($content -match "sfeir_student_portable")) {
        Add-Content $profilePath "`n"
        Get-Content "profiles.yml.example" | Add-Content $profilePath
        Write-Host "✓ Profil sfeir_student_portable ajouté" -ForegroundColor Green
    } else {
        Write-Host "✓ Profil sfeir_student_portable déjà présent" -ForegroundColor Green
    }
}
...
& "..\..\..\etudiant\portable\venv\Scripts\dbt.exe" seed --profiles-dir $dbtDir --profile sfeir_student_portable
Pop-Location
