...
echo ╔═══════════════════════════════════════════════════╗
echo ║  SFEIR School DBT - Setup Étudiant Portable      ║
echo ╚═══════════════════════════════════════════════════╝
echo.
...
if not exist "%USERPROFILE%\.dbt\profiles.yml" (
    ...
    if errorlevel 1 (
        ...
        echo ✓ Profil sfeir_student_portable déjà présent
    )
)
...
..\..\..\etudiant\portable\venv\Scripts\dbt.exe seed --profiles-dir %USERPROFILE%\.dbt --profile sfeir_student_portable
